...
PHRASE_PATTERNS = [
    ...
    r"\b(?:dependant|dependent).*\b(?:work|visa|right)s?.*\b(?:update|change|changes|updated)\b",
    r"\b(?:work hours|work rights).*\b(?:update|change|changes|updated)\b",
    r"\b(?:IHS|NHS surcharge)\b.*\b(?:update|change|changes|increase|decrease)\b",
    # permit/agency keywords
    r"\b(?:study|work|residence) permits?\b.*\b(?:change|changes|update|updates|updated)\b",
